...
define('dummy/initializers/browser/ember-smooch', ['exports', 'npm:smooch', 'ember-get-config'], function (exports, _npmSmooch, _emberGetConfig) {
  exports.initialize = initialize;

  function initialize() {
    if (_emberGetConfig['default'].smooch) {
      _npmSmooch['default'].init(_emberGetConfig['default'].smooch);
    } else {
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el2 = dom.createTextNode("Your Smooch window is in the bottom right corner of the screen");
...
define('dummy/config/environment', ['ember'], function(Ember) {
  return { 'default': {"modulePrefix":"dummy","environment":"development","baseURL":"/","locationType":"auto","smooch":{"appToken":"5wh2n4aov61rrki97jp8ludzr"},"EmberENV":{"FEATURES":{}},"APP":{"name":"ember-smooch","version":"latest"},"exportApplicationGlobal":true}};
});
...
if (!runningTests) {
  require("dummy/app")["default"].create({"name":"ember-smooch","version":"latest"});
}
